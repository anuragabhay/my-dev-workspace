...
- **Handoffs as slash commands**: when the next step is for another role, output the exact slash command (e.g. `/lead-engineer ...`, `/junior-engineer-1 ...`, `/reviewer ...`).

Reference: `.cursor/skills/junior-engineer-2/SKILL.md` if it exists.
